 ...
 * });
 */
export function useCartUpdateItemMutation(baseOptions?: Apollo.MutationHookOptions<CartUpdateItemMutation, CartUpdateItemMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CartUpdateItemMutation, CartUpdateItemMutationVariables>(CartUpdateItemDocument, options);
      }
